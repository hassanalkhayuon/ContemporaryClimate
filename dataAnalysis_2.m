...
[year month MthPrecip] = ...
    csvimport('PellyRanch-precip-data_mthly_0_MatlabFormat.csv', ...
    'columns', {'Year', 'Month', 'TtlP0'}, 'noHeader', false);
YrMth = year + month/12;
figure(1)
...
h_steps = figure('Name', 'Climate Steps');
...
h_DT = figure('Name', 'Detrended Data');
...
xlabel('Year')
ylabel('Precipitation')
title(['Annual Precip Adj,', delim, ', Pelly Ranch'])
...
title(['PDF Year Type Interval, ', delim, ', Pelly Ranch'])
